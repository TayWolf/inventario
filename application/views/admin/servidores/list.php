<section class="content-header">
    <h1>
        Servidores <small> Listado</small>
    </h1>
...
<section class="content">
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
            <input type="hidden" id="modulo" value="servidores">
            <div class="row">
                <div class="col-md-12">
                    <a href="<?php echo base_url();?>bienes/servidores/add" class="btn btn-primary btn-flat"><span class="fa fa-plus"></span>Agregar Servidor</a>
                    <hr>
                            ...
                            <tbody>
                                <?php foreach ($servidores as $servidor): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $servidor->unidad_almacenamiento?></td>
                                        <td><?php echo $servidor->ram?></td>
                                        <td><?php echo $servidor->direccion_ip?></td>
                                        <td><?php echo $servidor->sistema_operativo?></td>
                                        <td><?php echo $servidor->fecregistro_bien?></td>
                                        <td><?php echo $servidor->nombre_status?></td>
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary btn-flat btn-view" data-toggle="modal" data-target="#modal-default" value="<?php echo $servidor->id_bien;?>" title="Ver">
                                                    <span class="fa fa-eye"></span>
                                                </button>
                                                <a href="<?php echo base_url();?>bienes/servidores/edit/<?php echo $servidor->id_bien?>" class="btn btn-warning btn-flat" title="Editar"><span class="fa fa-pencil"></span></a>
                                                <?php if ($this->session->userdata("id_rol") == 1): ?>
                                                    <a href="<?php echo base_url();?>bienes/servidores/delete/<?php echo $servidor->id_bien?>" class="btn btn-danger btn-flat btn-delete" title="Eliminar">
                                                    <span class="fa fa-times"></span>
                                                </a>
                                                <?php endif ?>
                                                
                                                <button type="button" class="btn btn-info btn-flat btn-mante" data-toggle="modal" data-target="#modal-mantenimiento" title="Mantenimientos" value="<?php echo $servidor->id_bien;?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Informacion del Servidor</h4>
      </div>
