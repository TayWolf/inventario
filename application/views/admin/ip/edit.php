            ...
            <div class="row">
                <div class="col-md-6 col-sm-8 col-xs-12">
                    <form action="<?php echo base_url();?>configuraciones/ip/update" method="POST">
                        ...
                        <input type="hidden" name="idIp" value="<?php echo $ip->id;?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="descripcion" id="descripcion" class="form-control" value="<?php echo $ip->descripcion?>"  required="required">
                        </div>
